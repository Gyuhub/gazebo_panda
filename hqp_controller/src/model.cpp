...
int Model::get_model()
{
    ...
    std::string model_file_path = home_path + "/rp_ws/src/franka_gazebo/models/panda_arm_rbdl.urdf";
    //"/home/gyufoxy/rp_ws/src/franka_gazebo/models/panda_arm_rbdl.urdf"
